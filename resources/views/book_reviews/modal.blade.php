  ...
  <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
          ...
          <div class="modal-header">
              <h5 id="lbl-book_review-modal-title" class="modal-title">Book_review</h5>
          ...
          <div class="modal-body">
              ...
              <div class="modal-footer" id="div-save-mdl-book_review-modal">
                  <button type="button" class="btn btn-primary" id="btn-save-mdl-book_review-modal" value="add">Save</button>
              </div>
          </div>
...
<script type="text/javascript">
 ...
 $('#btn-save-mdl-book_review-modal').click(function(e) {
    console.log('hello');
        ...
        console.log($('#txt-book_review-primary-id').val());
